...
class IssueItem extends Component {
  ...
  render() {
    ...
    return (
      <div className={classNames('issue-item', {'issue-item--completed': issue.completed, 'issue-item--editing': editing})} tabIndex="0">
        <div className="cell">
          <button
            aria-hidden={editing}
            ...
            type="button">
            <svg className={classNames('icon', {'icon--active': issue.completed})} width="24" height="24" viewBox="0 0 24 24">
